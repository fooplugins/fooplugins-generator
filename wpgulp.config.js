...
module.exports = {
	...
	// Project options.
	projectURL: 'foo.dev.cc', // Local project URL of your already running WordPress site. Could be something like wpgulp.local or localhost:3000 depending upon your local WordPress setup.
	...
	// Translation options.
	textDomain: 'foogen', // Your textdomain here.
	translationFile: 'foogen.pot', // Name of the translation file.
	translationDestination: './languages', // Where to save the translation files.
	packageName: 'Fooplugins Plugin Generator', // Package name.
